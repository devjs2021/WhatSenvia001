...
import { notificationEmailRoutes } from "./modules/notifications/routes/notification-email.routes.js";
...
async function bootstrap() {
  ...
  await app.register(notificationEmailRoutes, { prefix: "/api/notification-emails" });
