...
function WAButton({ children, className = "" }: { children: React.ReactNode; className?: string }) {
  return (
    <a
      ...
      className={`inline-flex items-center justify-center gap-2.5 bg-emerald-600 hover:bg-emerald-500 text-white font-bold rounded-2xl transition-all hover:shadow-lg hover:shadow-emerald-500/25 hover:-translate-y-0.5 ${className}`}
    >
    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="border-b border-slate-100 bg-white/80 backdrop-blur-sm sticky top-0 z-50">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 h-14 flex items-center justify-between">
          ...
          <WAButton className="text-xs px-4 py-2">
            Escríbenos
          </WAButton>
        </div>
      </header>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            <div className="bg-white rounded-3xl border border-red-100 p-6 sm:p-8">
              ...
              <p className="text-sm text-slate-500 leading-relaxed">
                El 70% de las ventas por WhatsApp se pierden en la primera hora de contacto. Cada minuto sin respuesta es dinero que se va.
              </p>
            </div>
            <div className="bg-white rounded-3xl border border-red-100 p-6 sm:p-8">
              <div className="h-12 w-12 rounded-2xl bg-red-50 flex items-center justify-center mb-4">
              ...
              <p className="text-sm text-slate-500 leading-relaxed">
                Una sola queja y tu cuenta desaparece sin aviso — y con ella, todos tus contactos y clientes.
              </p>
            </div>
          </div>
        </div>
            ...
            {[
              {
                ...
                desc: "Responde, califica y agenda sin que muevas un dedo. Nunca más un lead sin respuesta.",
              },
              {
                icon: Shield,
                color: "bg-blue-50 text-blue-600",
                title: "Cuenta protegida con API oficial de Meta",
                desc: "La única integración aprobada por Meta. Cero riesgo de baneo. Cumple 100% sus políticas.",
              },
              {
                icon: Zap,
                color: "bg-amber-50 text-amber-600",
                title: "Tus anuncios abren WhatsApp directo",
                desc: "Click-to-WhatsApp nativo. El lead ve el anuncio, toca, y aterriza en tu WhatsApp ya calificado.",
              },
            ].map((item) => (
              <div key={item.title} className="bg-white rounded-3xl border border-slate-100 p-6 sm:p-8 hover:shadow-lg hover:shadow-slate-100 transition-shadow">
      ...
      <section className="bg-slate-50 py-16 sm:py-20">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            {/* Starter */}
            <div className="bg-white rounded-3xl border border-slate-200 p-6 sm:p-8 flex flex-col">
              ...
              <ul className="space-y-2.5 mb-8 flex-1">
                {["1 número de WhatsApp", "Bot básico", "500 conversaciones/mes", "Plantillas HSM incluidas"].map((f) => (
              ...
              <WAButton className="text-sm px-5 py-3 w-full">
                Empezar
              </WAButton>
            </div>

            {/* Pro — Destacado */}
            <div className="bg-white rounded-3xl border-2 border-emerald-500 p-6 sm:p-8 flex flex-col relative shadow-lg shadow-emerald-100">
              <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-emerald-600 text-white text-xs font-bold px-4 py-1 rounded-full flex items-center gap-1">
                <Star className="h-3 w-3" />
                Más elegido
              </div>
              <h3 className="text-lg font-bold text-slate-900">Pro</h3>
              <div className="mt-3 mb-5">
                <span className="text-3xl font-extrabold text-emerald-600">$49</span>
                <span className="text-sm text-slate-400">/mes</span>
              </div>
              <ul className="space-y-2.5 mb-8 flex-1">
                {[
                  "3 números de WhatsApp",
                  "Bot completo con calificación",
                  "2,000 conversaciones/mes",
                  "Click-to-WhatsApp nativo",
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-slate-500">
              <span className="font-bold text-emerald-600">Oferta de bienvenida:</span>{" "}
              14 días gratis + primer mes al 50% ($24.50 en vez de $49) + sesión de configuración incluida.{" "}
              <span className="text-slate-400">Solo para nuevos clientes.</span>
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <div className="bg-gradient-to-br from-emerald-600 to-emerald-700 rounded-3xl p-8 sm:p-12 text-center relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-2xl mx-auto mb-8 text-left">
                {[
                  ...
                  "Primer mes al 50% — pagas $24.50 en vez de $49",
                  "Sesión de configuración de 30 min incluida — te dejamos el bot listo",
                  "Garantía de 30 días — si no ves resultados, te devolvemos el dinero",
                ].map((item) => (
              ...
              <a
                ...
                rel="noopener noreferrer"
                onClick={trackWAClick}
                className="inline-flex items-center gap-2.5 bg-white text-emerald-700 font-bold text-base sm:text-lg px-8 py-4 rounded-2xl hover:shadow-lg hover:-translate-y-0.5 transition-all"
              >
                <svg className="w-5 h-5 shrink-0" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413Z" />
                </svg>
                Quiero esta oferta — escríbenos ahora
              </a>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 sm:py-24">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center">
          <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mb-6">
            ¿Listo para dejar de perder clientes y proteger tu WhatsApp de ventas?
          </h2>
          <WAButton className="text-base sm:text-lg px-8 py-4 sm:px-10 sm:py-5">
            Escríbenos por WhatsApp — empezamos hoy
          </WAButton>
          <p className="text-xs text-slate-400 mt-4">
            Sin tarjeta de crédito · Configuración en 30 minutos · Garantía 30 días
          </p>
        </div>
      </section>
