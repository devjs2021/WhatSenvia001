                ...
                <table className="w-full min-w-[820px]">
                  <thead>
                    <tr className="border-b border-slate-100 bg-slate-50/50">
                      ...
                      <th className="px-4 py-2.5 text-left text-xs font-semibold text-slate-400 uppercase tracking-wider">{t("metaTemplates.colNumber")}</th>
                            ...
                            {tpl.sessionNumbers && tpl.sessionNumbers.length > 0 ? (
                              <div className="flex flex-wrap gap-1">
                                {tpl.sessionNumbers.map((num, i) => (
                                  <span key={i} className="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-medium border bg-slate-100 text-slate-500">
                                    {num}
                                  </span>
                                ))}
                              </div>
